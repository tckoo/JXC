<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockWarn.aspx.cs" Inherits="warehouse_StockWarn" %>
...
<body>
    ...
    <div class="functionbabr">
        <input type="button" class="btn" value="打印" id="btnPrintAll" />
    </div>
    <div id="tbl">
    </div>
    <!-- 出入库详情 -->
    ...
    <script src="../js/warehouse/stockwarn.js" type="text/javascript"></script>
    </form>
</body>
</html>
