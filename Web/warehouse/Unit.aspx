<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Unit.aspx.cs" Inherits="warehouse_Unit" %>
...
<body>
    ...
    <fieldset style="padding: 10px 5px;">
        <legend style="font-size: 14px;">快速添加计量单位</legend>
    ...
    <fieldset style="padding: 10px 5px; display: none;" id="fEdit" runat="server">
        <legend style="font-size: 14px;">编辑计量单位</legend>
        <table cellpadding="0" cellspacing="0" border="0" class="searchbar">
            <tr>
                <th>
                    单位名称:
