...
public partial class warehouse_Stock : System.Web.UI.Page
{
    #region URL参数
    /// <summary>
    /// 异步请求功能参数
    ...
    private byte LibType
    {
        get
        {
            return byte.Parse(Utils.GetParams("type", "0"));
        }
    }
    #endregion
    ...
    private void ProcessRequest()
    {
        ...
        switch (Tag)
        {
            ...
            case "GET_PRODUCT_LIST":
                res = Utils.ToJson(bll.GetProductList(Guid.Parse(Session["obj_id"] + ""), SubCtg, Key));
                break;
            // 获取出入库详情
            case "GET_IN_OUT_WAREHOUSE_DETAIL":
                res = Utils.ToJson(bll.GetInOutWarehouseDetail(ProductID, Guid.Parse(Session["obj_id"] + ""), LibType));
                break;
        }
