...
public partial class warehouse_FCtg : System.Web.UI.Page
{
    ...
    private void BindProductCtg()
    {
        ...
        DataTable dt = bll.GetDictionarysForUser("ZW");
    ...
    {
        DictionaryBLL bll = new DictionaryBLL();
        List<T_Dictionary> list = bll.GetDictionarys("ZW", Guid.Parse(Session["obj_id"] + ""));
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            obj.F_ParID = bll.GetDicIDByCode("ZW");
        }
        else
        {
        ...
        if (bll.AddDictionary("ZW", Config.KEY_ZWLB, obj))
        {
            BindProductCtg();
