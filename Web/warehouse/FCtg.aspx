<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FCtg.aspx.cs" Inherits="warehouse_FCtg" %>
...
<body>
    ...
    <fieldset style="padding: 10px 5px;">
        <legend style="font-size: 14px;">快速添加账务分类</legend>
    ...
    <fieldset style="padding: 10px 5px; display: none;" id="fEdit" runat="server">
        <legend style="font-size: 14px;">编辑账务分类</legend>
        <table cellpadding="0" cellspacing="0" border="0" class="searchbar">
            <tr>
                <th colspan="2" style="text-align: left;">
                    请选择类型:
            ...
            <tr style="height: 60px; line-height: 60px;">
                <td colspan="6">
                    <webdiyer:AspNetPager CssClass="pages" CurrentPageButtonClass="cpb" ID="aspCtg" runat="server"
                        PageSize="8" FirstPageText="首页" LastPageText="尾页" NextPageText="下一页" PrevPageText="上一页"
                        AlwaysShow="true" OnPageChanged="aspCtg_PageChanged">
