...
<body>
    ...
    <div class="left">
        ...
        <dl>
            ...
            <dd>
                <a href="javascript:;">出入库查询</a></dd>
            <dd>
                <a href="javascript:;">库存查询</a></dd>
        </dl>
        <dl>
            <dt><i class="title5"></i><em>销售管理</em></dt>
            <dd>
                <a href="javascript:;">分店销售查询</a></dd>
            <dd>
                <a href="javascript:;">销售统计</a></dd>
        </dl>
        <dl>
        ...
        <dl>
            ...
            <dd>
                <a href="Person.aspx" target="f">员工管理</a></dd>
            <dd>
                <a href="Objects.aspx" target="f">分店仓库管理</a></dd>
            <dd>
                <a href="Dictionary.aspx" target="f">字典数据维护</a></dd>
            <dd>
                <a href="javascript:;">数据库备份</a></dd>
        </dl>
    </div>
    <div class="right">
        <iframe name="f" src="Dictionary.aspx" scrolling="no" frameborder="0" width="100%"
            onload="this.height=window.innerHeight-document.getElementById('top').offsetHeight-10;">
        </iframe>
    </div>
